...
const { enrollCourse, checkEnrollment } = require('../controllers/enrollmentController');
...
router.put('/:courseId/lessons/:lessonId', verifyToken, requireTeacher, updateLesson);
router.delete('/:courseId/lessons/:lessonId', verifyToken, requireTeacher, deleteLesson);
router.post('/:courseId/enroll', verifyToken, enrollCourse);
router.get('/:courseId/check-enrollment', verifyToken, checkEnrollment);
